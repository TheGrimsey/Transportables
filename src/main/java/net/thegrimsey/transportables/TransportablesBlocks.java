...
public class TransportablesBlocks {
    public static final FabricBlockSettings RAIL_SETTINGS = FabricBlockSettings.create().nonOpaque().noCollision().strength(0.7F).sounds(BlockSoundGroup.METAL);
    ...
    public static final IronLadder IRON_LADDER = new IronLadder(FabricBlockSettings.create().nonOpaque().strength(0.7F).sounds(BlockSoundGroup.METAL));
    ...
    public static void RegisterBlocks() {
        ...
        TELESENDER_RAILENTITY = Registry.register(Registries.BLOCK_ENTITY_TYPE, new Identifier(Transportables.MODID, "telesender_railentity"), FabricBlockEntityTypeBuilder.create(TeleSender_RailEntity::new, TELESENDER_RAIL).build(null));
    }

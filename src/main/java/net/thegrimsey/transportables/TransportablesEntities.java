...
public class TransportablesEntities {
    ...
    public static void RegisterEntities()
    {
        ...
        CHEST_CARRIAGE = Registry.register(Registry.ENTITY_TYPE, new Identifier(Transportables.MODID, "chest_carriage"), FabricEntityTypeBuilder.create(SpawnGroup.MISC, ChestCarriageEntity::new).dimensions(CarriageEntity.CARRIAGE_DIMENSIONS).build());
